...
client.on('message', message => {
    if(message.content == ('+profile')) {    
     ...
     const w = ['ID1.png','ID1.png','ID1.png','ID1.png','ID1.png'];
...
const channel = sWlc[message.guild.id].channel
  if (message.content.startsWith(prefix + "setwelcomer")) {
    if (!message.member.hasPermission("MANAGE_GUILD")) return message.reply("ليس لديك صلاحيات");
                  ...
                  ctx.drawImage(ground, 0, 0, 540, 230);
                      ...
                      jimp.read(url, (err, ava) => {
                          ...
                          ava.getBuffer(jimp.MIME_PNG, (err, buf) => {
                              ...
                              ctx.fontSize = '25px';
                              ctx.fillStyle = "#FFFFFF";
                                ctx.fillText(member.user.username, 280, 140);
                              
                              //NAMEً
                              ctx.font = '21px kathen';
                              ctx.fontSize = '20px';
                              ctx.fillStyle = "#a09d9d";
      ctx.fillText(`${member.guild.name}`, 250, 80);
...
client.login("NDkzMDkxMTgxMjk5ODkyMjM5.D31ymA.zU0UTPbXcFTme_QF0R924Ivs9x0");
